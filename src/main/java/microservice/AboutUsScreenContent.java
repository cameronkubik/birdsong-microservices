...
public class AboutUsScreenContent {
    ...
    public AboutUsScreenContent(String _title, long _id, String _posterImagePath, String _overview, String _releaseDate, String _backdropImagePath, int _screenShowingOn) {
        title = _title;
        id = _id;
